...
import com.voronov.springDemo.controller.MessageController;
...
@WithUserDetails(value = "firstUser")
public class MessageControllerTest {
    ...
    @Test
    public void
    mainPageTest() throws Exception{
        this.mockMvc.perform(get("/main"))
                .andDo(print())
                .andExpect(authenticated())
                .andExpect(xpath("//div[@id='navbarSupportedContent']/div").string("2"));
    }
    @Test
